...
export default function ResumePage(): React.ReactElement {
  // Set page title
  useEffect(() => {
    document.title = "Resume | Esa Krissa — Python Backend Engineer";
  }, []);
    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="no-print fixed top-0 left-0 right-0 bg-white border-b border-zinc-200 z-50">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link
            href="/"
            className="font-mono text-sm text-zinc-600 hover:text-black hover:underline"
          >
            ← Back to Portfolio
          </Link>
          <button
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 pt-24 print:pt-0 print:px-0">
        ...
        <section className="mb-6 print:mb-4">
          ...
          <p className="text-sm leading-relaxed text-zinc-700">
            <strong>Python Backend Engineer</strong> with 5+ years of Python
            experience building backend systems, AI agents, and microservices
            with FastAPI, LangChain, LangGraph, and MCP on AWS and GCP.
            Published researcher on AI-based travel agent architectures and
            chatbot search algorithms. Based in Bali, Indonesia. Focused on
            shipping production-grade APIs, multi-agent systems, and
            ...
            <div>
              ...
              <ul className="text-zinc-600 text-sm">
                <li>
                  ...
                  (1,600+ day Duolingo streak, Score: 130)
                </li>
                <li>
                  • <strong className="text-black">Indonesian</strong> – Native
                </li>
                <li>
                  • <strong className="text-black">Balinese</strong> – Native
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-zinc-600 text-sm">
                ...
                <li>• 24+ GitHub repositories, primarily Python</li>
                <li>• Open-source MCP server with 13+ stars</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-6 print:mb-4">
          ...
          <div className="text-sm text-zinc-600 space-y-1">
            <p>
              <strong>Work Authorization:</strong> Legal right to work in
              Indonesia (Indonesian citizen)
            </p>
            <p>
              <strong>Availability:</strong> Immediate • Open to remote roles,
              aligned with APAC and EU timezones
            </p>
            <p>
              <strong>Development Tools:</strong> Cursor IDE, Claude Code, Git,
              Docker, Terraform
            </p>
            <p>
              <strong>Interests:</strong> Architecture & properties, Music
              (singer-songwriter), Continuous learning
            </p>
          </div>
        </section>
