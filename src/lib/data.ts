...
export const profile: Profile = {
  ...
  bio: `Python Backend Engineer building backend systems, AI agents, and microservices.
        Experienced with FastAPI, LangChain, LangGraph, and MCP on AWS and GCP.
        Based in Bali, Indonesia. Published researcher on AI-based travel agents
        and chatbot search algorithms.`,
...
export const technologies = {
  ...
  typescript: createTechnology("TypeScript", "language", "advanced", 4),
  javascript: createTechnology("JavaScript", "language", "advanced", 5),
  go: createTechnology("Go", "language", "intermediate", 2),
  ...
  nextjs: createTechnology("Next.js", "framework", "advanced", 3),
  nodejs: createTechnology("Node.js", "framework", "advanced", 4),
  ...
  claudeCode: createTechnology("Claude Code", "tool", "expert", 1),

  // AI/ML
  openai: createTechnology("OpenAI API", "tool", "expert", 2),
  anthropic: createTechnology("Anthropic API", "tool", "expert", 1),
} as const;
...
export const skills: readonly Skill[] = [
  ...
  {
    category: "Dev Tools",
    items: [technologies.cursor, technologies.claudeCode],
  },
] as const;
...
export const projects: readonly Project[] = [
  ...
  },
  {
    ...
    status: "active",
    repoUrl: createValidURL(
      "https://github.com/esakrissa/microservices-deployment",
    ),
    stars: 0,
    forks: 1,
    language: "Python",
  ...
  },
  {
    ...
    technologies: [technologies.python, technologies.mcp],
    status: "active",
  ...
  },
  {
    ...
    status: "active",
    repoUrl: createValidURL(
      "https://github.com/esakrissa/langgraph-interrupt-cli",
    ),
    stars: 0,
    forks: 0,
    language: "Python",
  ...
  },
  {
    ...
    technologies: [technologies.python, technologies.redis],
    status: "active",
  ...
  },
  {
    ...
    technologies: [technologies.python, technologies.openai, technologies.mcp],
    status: "active",
...
export const meta = {
  title: "Esa Krissa | Python Backend Engineer",
  description:
    "Python Backend Engineer building backend systems, AI agents, and microservices with FastAPI, LangChain, and MCP. Based in Bali, Indonesia.",
  keywords: [
    "Python",
    "Backend Engineer",
    "FastAPI",
